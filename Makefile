...
# Generated by qmake (2.01a) (Qt 4.7.2) on: Fri Apr 15 17:52:20 2011
# Project:  raymini.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .obj/raymini1.0.0/ && $(COPY_FILE) --parents Window.h GLViewer.h QTUtils.h Vertex.h Triangle.h Mesh.h BoundingBox.h Material.h Object.h Light.h Scene.h RayTracer.h Ray.h QClickableLabel.hpp .obj/raymini1.0.0/ && $(COPY_FILE) --parents Window.cpp GLViewer.cpp QTUtils.cpp Vertex.cpp Triangle.cpp Mesh.cpp BoundingBox.cpp Material.cpp Object.cpp Light.cpp Scene.cpp RayTracer.cpp Ray.cpp QClickableLabel.cpp Main.cpp .obj/raymini1.0.0/ && (cd `dirname .obj/raymini1.0.0` && $(TAR) raymini1.0.0.tar raymini1.0.0 && $(COMPRESS) raymini1.0.0.tar) && $(MOVE) `dirname .obj/raymini1.0.0`/raymini1.0.0.tar.gz . && $(DEL_FILE) -r .obj/raymini1.0.0
